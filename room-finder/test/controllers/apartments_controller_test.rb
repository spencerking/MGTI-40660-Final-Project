...
class ApartmentsControllerTest < ActionController::TestCase
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post :create, apartment: { Apt_complex_id: @apartment.Apt_complex_id, description: @apartment.description, floor: @apartment.floor, isVacant: @apartment.isVacant, price: @apartment.price, room: @apartment.room }
    end
  ...
  test "should update apartment" do
    patch :update, id: @apartment, apartment: { Apt_complex_id: @apartment.Apt_complex_id, description: @apartment.description, floor: @apartment.floor, isVacant: @apartment.isVacant, price: @apartment.price, room: @apartment.room }
    assert_redirected_to apartment_path(assigns(:apartment))
  end
